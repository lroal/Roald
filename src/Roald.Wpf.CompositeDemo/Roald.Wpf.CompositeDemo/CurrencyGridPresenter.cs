...
{
    internal class CurrencyGridPresenter : ICurrencyGridPresenter
    {
        ...
        public CurrencyGridPresenter(ICurrenciesView view, IGetCurrenciesService getCurrenciesService, ICurrencyPresenterFactory currencyPresenterFactory)
        {
            _view = view;
        ...
        private void OnCurrenciesReceived(IEnumerable<ICurrency> currencies)
        {
            foreach (var currency in currencies)
            {
                ...
                presenter.Activate(_view.Grid.CreateRow());
