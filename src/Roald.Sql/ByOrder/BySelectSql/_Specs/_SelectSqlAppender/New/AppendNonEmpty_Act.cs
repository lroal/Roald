...
{
    internal abstract class AppendNonEmpty_Act : New_Act
    {
        protected string Returned { get; set; }
        protected const string InitialStatement = "initialStatement";
        protected const string AppendString = "appended";
        protected NonEmptySqlElementFake EmptySqlElement = new NonEmptySqlElementFake(AppendString);
